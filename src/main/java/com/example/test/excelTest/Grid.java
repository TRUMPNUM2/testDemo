...
public class Grid {
    ...
    private String text;
    /*Font.PLAIN*/
    private java.awt.Font font = new java.awt.Font("微软雅黑", java.awt.Font.PLAIN, 12);
    private java.awt.Color bgColor = null;
    private Short horizontalAlignmentCode;
    ...
    public java.awt.Color getFtColor() {
        return ftColor;
    }
    ...
    public void setFont(org.apache.poi.ss.usermodel.Font font) {
        if (font != null) {
            this.font = new java.awt.Font(font.getFontName(), Font.BOLDWEIGHT_BOLD, font.getFontHeight() / 20 + 2);
        }
    }
    ...
    private java.awt.Color poiColor2awtColor(org.apache.poi.ss.usermodel.Color color) {
        ...
        if (color instanceof XSSFColor) {     //.xlsx
            ...
            if (rgbHex != null) {
                awtColor = new java.awt.Color(Integer.parseInt(rgbHex.substring(2), 16));
            }
        } else if (color instanceof HSSFColor) {   //.xls
            HSSFColor hc = (HSSFColor) color;
            short[] s = hc.getTriplet();
            if (s != null) {
                awtColor = new java.awt.Color(s[0], s[1], s[2]);
            }
        }
        return awtColor;
    }
